...
function drawCircle(gridCell) {
  var x = CELL_WIDTH*gridCell.j + CELL_WIDTH*0.5;
  var y = CELL_HEIGHT*gridCell.i + CELL_HEIGHT*0.5;
  var r = CELL_WIDTH*0.5; // assume a square cell
